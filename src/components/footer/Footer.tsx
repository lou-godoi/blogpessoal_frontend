import { BehanceLogoIcon, GithubLogoIcon, LinkedinLogoIcon } from "@phosphor-icons/react"
...
function Footer() {
    ...
    return (
        <>
            <div className="flex justify-center bg-purple-900 text-teal-400 relative z-50">
